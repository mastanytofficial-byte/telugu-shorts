...
const providerReplacement = [
  ...
  '',
  'const LLM_PROVIDERS = [',
  "  { name: 'cerebras', key: ROUTER_CEREBRAS_API_KEY, url: 'https://api.cerebras.ai/v1/chat/completions', model: 'gpt-oss-120b', maxTokens: 2200 },",
  "  { name: 'groq-120b', key: ROUTER_GROQ_API_KEY, url: 'https://api.groq.com/openai/v1/chat/completions', model: 'openai/gpt-oss-120b', maxTokens: 2200 },",
  "  { name: 'groq-20b', key: ROUTER_GROQ_API_KEY, url: 'https://api.groq.com/openai/v1/chat/completions', model: 'openai/gpt-oss-20b', maxTokens: 1600 },",
