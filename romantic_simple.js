...
function render(image,bgm,quote){
  ...
  const vf=`scale=1080:1920:force_original_aspect_ratio=increase,crop=1080:1920,drawbox=x=90:y=610:w=900:h=700:color=black@0.34:t=fill,drawtext=fontfile='${font}':textfile='${txt}':fontcolor=white:fontsize=36:line_spacing=16:fix_bounds=true:expansion=none:x=110:y=680:box=1:boxcolor=black@0:boxborderw=0:shadowcolor=black@1:shadowx=2:shadowy=3`;
