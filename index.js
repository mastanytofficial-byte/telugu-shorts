...
కింద ఇచ్చిన fact (verify చేయబడింది, మార్చకూడదు) ని — ఒక ఉత్కంఠభరితమైన రహస్యం మీ best friend కి చెప్తున్నట్టు చెప్పు, ఆ friend 5 సెకన్లలో బోర్ అయిపోయే వ్యక్తి అనుకో:
...
తేడా గమనించావా? రెండోది ప్రతి 2-3 వాక్యాలకూ కొత్త curiosity పుట్టిస్తుంది, సమాధానం వెంటనే ఇవ్వదు — దాన్ని stretch చేస్తుంది. ఏ వాక్యమైనా కేవలం information ఇస్తే (వినేవారికి "అమ్మో నిజంగానా!" అనిపించకపోతే), దాన్ని ఈ స్టైల్‌లో తిరిగి రాయి.

నిర్మాణం — ఈ 6 దశలు (ఇచ్చిన fact లోని విషయాన్నే వాడుతూ, కొత్తది కల్పించకుండా): Question → Small Reveal (stretch చేసి, వెంటనే కాదు) → New Question → Bigger Reveal → Twist (script మధ్యలో, "కానీ..." తో suspense-build-up తర్వాత punch) → Ending (గుర్తుండిపోయే లైన్).
...
2. STYLE: పైన చూపిన "ఇలా రాయి" ఉదాహరణ style లోనే — jargon-dump వద్దు.
