...
**ప్రత్యేక జాగ్రత్త — నిర్దిష్ట పరిశోధకుడి పేరు/సంస్థ పేరు/ప్రదేశం పేరు:** ఇలాంటి పేర్లు తప్పుగా గుర్తుండటం (ఉదా. ఒక ప్రసిద్ధ ప్రయోగాన్ని పోలిన మరో పరిశోధకుడి పేరుతో కలిపేయడం — Stanley Milgram యొక్క obedience ప్రయోగాన్ని, పూర్తిగా వేరైన Latané & Darley యొక్క bystander effect ప్రయోగంతో పొరబడటం వంటివి) చాలా సాధారణం. ఒక నిర్దిష్ట పేరు (వ్యక్తి/సంస్థ/హోటల్/నగరం) కచ్చితంగా సరైనదని నీకు 100% నమ్మకం లేకపోతే, ఆ పేరును అస్సలు రాయకు — బదులుగా "ఒక పరిశోధనలో"/"శాస్త్రవేత్తలు" అని generic గా రాయి. తప్పు పేరుతో చెప్పడం కంటే పేరు లేకుండా చెప్పడమే మంచిది.
...
1) ACCURACY: ఇందులో స్పష్టంగా తప్పు కావొచ్చు అని గుర్తించదగ్గ నిర్దిష్ట సంఖ్య/పేరు/వాదన ఉందా? **ప్రత్యేకంగా చెక్ చేయి:** ఇందులో ఏదైనా నిర్దిష్ట పరిశోధకుడి పేరు/సంస్థ పేరు/ప్రదేశం పేరు ఉంటే, అది ఆ ప్రయోగం/సంఘటనకు నిజంగా సరిపోయే సరైన పేరేనా అని ప్రత్యేకంగా ఆలోచించు (ఉదా. పోలిన మరో ప్రసిద్ధ ప్రయోగంతో పేరు కలిపేయడం లాంటి mix-up జరిగే అవకాశం ఉంది) — నిర్దిష్ట పేరు సరైనదని ఖచ్చితంగా నమ్మకం లేకపోతే REJECTED అని రాయి.

2) VIRAL APPEAL (0-100): Scroll-stopping power, curiosity, shock value, emotional reaction, shareability, comment potential, తెలుగు audience relevance, visual potential, retention potential, originality — వీటన్నింటినీ కలిపి ఆలోచించి ఒక మొత్తం స్కోరు ఇవ్వు. **negative factor:** భారీ technical/scientific jargon (ఉదా. 'exponent', 'attractor') అవసరమైతే స్కోరు తగ్గించు — jargon లేకుండా రోజువారీ మాటల్లో పూర్తిగా చెప్పగలిగే fact కే ఎక్కువ స్కోరు ఇవ్వు.
...
నియమాలు:
- ప్రతి అంకెల సంఖ్యను (సంవత్సరాలు, లెక్కలు, శాతం, కొలతలు సహా) తెలుగు మాటల్లోకి మార్చు — **సాధారణ నియమం (తెలుగు లక్ష/కోటి పద్ధతిలో — ఆంగ్ల million పద్ధతిలో కాదు):** పెద్ద భాగం నుండి చిన్న భాగం వరకు వరుసగా చెప్పు, ప్రతి భాగం 0 అయితే పూర్తిగా వదిలేయి — కోట్ల భాగం (సరిగ్గా 1 కోటి అయితే 'కోటి', ఎక్కువైతే 'X కోట్లు'), లక్షల భాగం (సరిగ్గా 1 లక్ష అయితే 'లక్ష', ఎక్కువైతే 'X లక్షలు'), వేల భాగం (సరిగ్గా 1000 అయితే ఎప్పుడూ 'వెయ్యి' — 'ఒక్కటి వేల' అని ఎప్పుడూ రాయకు, ఎక్కువైతే 'X వేల'), వందల భాగం (0 కాకుండా ఉంటేనే 'Y వందల'), చివరగా పదులు+units భాగం (0 కాకుండా ఉంటేనే) — మధ్యలో ఉన్న సున్నా భాగాలను ఎప్పుడూ 'సున్నా' అని పలకవద్దు లేదా అంకెలవారీగా చదవకు. 'వంద వేల' అని ఎప్పుడూ రాయకు — అది 'లక్ష'. ఉదా: 24 → ఇరవై నాలుగు, 1000 → వెయ్యి, 1009 → వెయ్యి తొమ్మిది, 1500 (count/quantity) → వెయ్యి ఐదు వందల, 2000 → రెండు వేల, 10000 → పది వేల, 100000 → లక్ష, 150000 → లక్ష యాభై వేల, 500000 → ఐదు లక్షలు, 10000000 → కోటి.
- **మినహాయింపు — YEARS/తేదీలు మాత్రమే:** ఒక సంఖ్య ఒక సంవత్సరాన్ని/తేదీని సూచిస్తే (ఏదో సంఘటన ఏ సంవత్సరంలో జరిగిందో చెప్పేటప్పుడు — ఉదా. వాక్యంలో 'లో' తో కలిసి కనిపించే సందర్భం, "1920లో", "1974 ప్రయోగం"), మరియు అది 1100-1999 మధ్య ఉంటే, పైన చెప్పిన 'వెయ్యి...' పద్ధతి కాకుండా 'XX వందల Y' అనే century-pair పద్ధతిలోనే మార్చు — ఇది సహజ మాట్లాడే తెలుగు (ఆంగ్లంలో "nineteen seventy-four" అన్నట్టే, "one thousand nine hundred seventy-four" అనరు). ఉదా: 1974 (సంవత్సరం) → పందొమ్మిది వందల డెబ్బై నాలుగు (కాదు వెయ్యి తొమ్మిది వందల డెబ్బై నాలుగు), 1920 (సంవత్సరం) → పందొమ్మిది వందల ఇరవై, 1904 (సంవత్సరం) → పందొమ్మిది వందల నాలుగు. ఇది సంవత్సరాలకు మాత్రమే — count/quantity అయితే (ఉదా. '1500 జాతులు') పైన చెప్పిన సాధారణ 'వెయ్యి...' పద్ధతినే వాడు. 2000 తర్వాతి సంవత్సరాలకు (ఉదా. 2024) ఇది వర్తించదు — వాటికి యథావిధిగా 'రెండు వేల ఇరవై నాలుగు' వాడు. **ఈ మార్పు చేసేటప్పుడు మార్చిన సంఖ్య విలువ ఖచ్చితంగా అసలు సంఖ్యతో సరిపోలాలి — జాగ్రత్తగా, తప్పుగా లెక్కించకుండా మార్చు.**
...
// saw.
//
// A fifth real shipped script (run #300) then produced a hook asking
// "ఎలెక్ట్రిక్ ఈల్స్ తమ స్వంత విద్యుత్తుతో అంధులైపోతాయా...?" (do electric
// eels go blind from their own electricity?) — but the Reveal/Detail/Twist/
// Ending beats that followed only ever explained voltage generation and
// shock range, NEVER anything about eyesight/blindness. makePrompt() already
// requires "3 Reveal — హుక్ కి అసలు జవాబు" (Reveal must actually answer the
// hook), but nothing enforced it — the guard's oneSentence()/word-count/
// grounding checks all passed since every individual beat was internally
// fine, just disconnected from the hook's specific claim. Category 5 below
// targets this directly. The SAME run also had "వారు తమ శరీరాన్ని
// మసకబార్చుకోవడానికి కాదు, మునుగుతున్న రోడ్డులో చంపుటకు ఉపయోగించి..." —
// "రోడ్డు" (road) is a real, correctly-spelled Telugu-loanword word, and
// grammatically the sentence is fine, but a "road" makes no sense at all in
// an underwater eel-attack scene — this pass ran and silently no-op'd,
// missing it. Category 3's example below now includes this alongside the
// "సజీవం" case so "contradicts the theme" explicitly covers a setting/
// object that doesn't belong in the scene, not just a wrong descriptive
// word.
//
...
వెతకవలసిన 5 రకాల తప్పులు:
1. నిజంగా లేని/విరిగిపోయిన/అర్థం లేని పదం (garbled లేదా invented word) — ఉదా. "సముద్రపు వర్షాభి" (వర్షాభి నిజమైన పదం కాదు) — సరైనది: "సముద్రపు వర్షారణ్యాలు". **ప్రత్యేకంగా జాగ్రత్త — English transliteration లు తప్పుగా కలిసిపోవడం:** "కాంగ్రెస్మెం"("కాంగ్రెస్‌మెన్"), "బైోమెట్రిక్"("బయోమెట్రిక్"), "పన్నెడు"("పన్నెండు"-12) వంటివి — నిజమైన పదంలానే అనిపించొచ్చు కానీ తెలుగులో లేని పదాలు. ప్రతి transliteration/సంఖ్య పదాన్ని జాగ్రత్తగా పరిశీలించు.
...
3. ఆ వాక్యంలో ఒంటరిగా చూస్తే సరైనట్టు అనిపించే నిజమైన పదమే, కానీ స్క్రిప్ట్‌లో మిగతా చోట్ల ఏర్పడే అసలు theme/scene/setting కి విరుద్ధంగా ఉంది. ఉదా: (a) "రంగు perception" గురించిన script హుక్‌లో "మెదడు సజీవం లేదా చల్లటి అనిపించగలదా?" — "సజీవం" నిజమైన పదమే కానీ theme "వెచ్చని vs చల్లని రంగు" కాబట్టి "వెచ్చగా" రావాలి. (b) నీటి అడుగున scene లో "మునుగుతున్న రోడ్డులో చంపుటకు ఉపయోగించి" — "రోడ్డు" సరైన పదమే కానీ ఆ scene కి పూర్తిగా అసందర్భం. ఇలాంటివి పట్టుకోవాలంటే స్క్రిప్ట్ మొత్తం చదివిన తర్వాతే ఏ వాక్యాన్ని judge చేయాలి, ఒంటరిగా చూసి కాదు.
4. అదే measurement గురించి script లో వేర్వేరు చోట్ల పరస్పర విరుద్ధమైన సంఖ్యలు ఇవ్వడం — ఉదా. "వాతావరణ ఒత్తిడి ఒక బార్ స్థాయిలో ఉంది ఇది 1.5 బార్ ఒత్తిడితో సమానంగా ఉంటుంది" (అదే pressure కి "1 bar" మరియు "1.5 bar" రెండూ). సరైనది: **script లో ఇప్పటికే ఉన్న రెండు సంఖ్యల్లో ఒకదాన్నే ఉంచి** (కొత్త మూడో సంఖ్య కల్పించకు), రెండోదాన్ని తీసేయడం ద్వారా లేదా అవి వేర్వేరు విషయాలకు (ఉదా. Titan vs భూమి) సంబంధించినవని స్పష్టం చేస్తూ ఫిక్స్ చేయి.
5. హుక్ ఒక నిర్దిష్ట ప్రశ్న/claim అడిగింది, కానీ తర్వాత వచ్చే వాక్యాలు దానికి జవాబు ఇవ్వవు — ఉదా. హుక్‌లో "ఎలెక్ట్రిక్ ఈల్స్ తమ స్వంత విద్యుత్తుతో అంధులైపోతాయా?" అడిగి, తర్వాతంతా voltage గురించి మాత్రమే చెప్పి "అంధులైపోవడం" ప్రస్తావననే లేకపోవడం. ఇలాంటప్పుడు హుక్‌ని script తర్వాత నిజంగా వివరించే విషయానికి సరిపోయేలా (ఇక్కడ: voltage/shock power), **దాదాపు అదే పొడవుతో** తిరిగి రాయి — మిగతా భాగం మార్చకు.

ఖచ్చితమైన నియమాలు:
- పైన చెప్పిన 5 రకాల తప్పులు ఉన్న చోట మాత్రమే, ఆ ఒక్క పదం/పదబంధాన్ని/వాక్యభాగాన్ని మాత్రమే సరైన, సహజమైన, స్క్రిప్ట్ యొక్క నిజమైన theme కి సరిపోయే దానితో replace చేయి — మిగతా భాగం ఖచ్చితంగా అలాగే ఉంచు.
...
- పదాలు మొత్తం సంఖ్య పెద్దగా మారకూడదు — వాక్య నిర్మాణం, పదాల క్రమం, sentence/line count, '?' సంఖ్య అన్నీ ఖచ్చితంగా అలాగే ఉంచు. 5వ రకం తప్పు ఫిక్స్ చేసేటప్పుడు కూడా హుక్ వాక్యం పొడవు దాదాపు మారకుండా చూసుకో.
