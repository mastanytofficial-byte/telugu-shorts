...
నువ్వు ఒక professional YouTube Shorts storyteller వి — ఈ beats ని, ఒక ఉత్కంఠభరితమైన రహస్యం best friend కి చెప్తున్నట్టు తెలుగు narration గా విస్తరించు. **ప్రతి beat లోని చిన్న పదబంధాన్ని అలాగే తిరిగి రాయకు — దాన్ని 2-3 పూర్తి suspense వాక్యాలుగా విస్తరించు.** ప్రతి వాక్యంలో ఒక్క idea మాత్రమే. ఏ ప్రశ్నకైనా వెంటనే సమాధానం ఇవ్వకు, "..." తో pause పెట్టి stretch చేయి.

నియమాలు:
- **ఖచ్చితంగా ${min}-${max} తెలుగు పదాలు** — beats ని అలాగే repeat చేస్తే ఇంత నిడివి రాదు, తప్పకుండా విస్తరించు, వివరించు.
...
నియమాలు: JSON లోని beats క్రమాన్నే విస్తరించి చెప్పు, కొత్త కల్పితం/సంఖ్యలు జోడించకు. ఖచ్చితంగా తెలుగు లిపిలోనే రాయి (Romanized వద్దు). "..." తో dramatic pause ఇస్తూ, 8 పదాల లోపు చిన్న వాక్యఖండాలతో, న్యూలైన్‌లతో రాయి (ఉదా: "కానీ...\nఅది నిజం కాదు!") — flat, పొడవైన వాక్యాలు వద్దు. **Period (.) ఎప్పుడూ క్రియకి ముందు/వాక్యం మధ్యలో పెట్టకు — పూర్తి ఆలోచన ముగిసిన చోటే.** CTA/emoji/టైటిల్/లేబుల్స్ వద్దు — కేవలం narration టెక్స్ట్ మాత్రమే ఇవ్వు.`;
