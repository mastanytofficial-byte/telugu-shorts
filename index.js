...
**ప్రత్యేక జాగ్రత్త:** పరిశోధకుడు/సంస్థ/ప్రదేశం పేరు కచ్చితంగా సరైనదని 100% నమ్మకం లేకపోతే (ఉదా. పోలిన మరో ప్రయోగంతో పేరు కలిపేయడం — Milgram vs Latané & Darley వంటి mix-ups) ఆ పేరు రాయకు, బదులుగా "ఒక పరిశోధనలో"/"శాస్త్రవేత్తలు" అని generic గా రాయి. తప్పు పేరు కంటే పేరు లేకపోవడమే మంచిది.
...
1) ACCURACY: ఇందులో స్పష్టంగా తప్పు కావొచ్చు అని గుర్తించదగ్గ నిర్దిష్ట సంఖ్య/పేరు/వాదన ఉందా? నిర్దిష్ట పరిశోధకుడు/సంస్థ/ప్రదేశం పేరు ఉంటే, అది సరైనదేనా అని ప్రత్యేకంగా చెక్ చేయి (పోలిన మరో ప్రయోగంతో పేరు mix-up అయ్యే అవకాశం ఉంది) — ఖచ్చితంగా నమ్మకం లేకపోతే REJECTED అని రాయి.
