...
async function generateNewFactOutline(category, existingOutlines) {
  ...
  const prompt = `${category} విభాగంలో ఒక extremely rare, ఆశ్చర్యపరిచే, verified fact ఒకటి తెలుగులో ఇవ్వు — ఇది చాలా మంది తెలుగు వాళ్ళు ఇంతకుముందు వినని విషయం అయ్యుండాలి, YouTube/Instagram/TikTok లో ఇప్పటికే వందల సార్లు repeat అయిన fact కాదు.

**ఖచ్చితంగా వీటిని (లేదా వీటికి దగ్గరి సంబంధమున్న దేన్నైనా) వాడకు — ఇవి already YouTube లో లక్షల సార్లు repeat అయ్యాయి:** ఆక్టోపస్ గుండెలు, తేనె expire అవ్వదు, అరటిపండు berry, సొరచేపలు నిద్రపోవు, చంద్రుడు ఒకే వైపు చూపించడం, జిరాఫీ మెడ, ఈఫిల్ టవర్.

ఇప్పటికే వాడినవి (వీటిని గానీ, వీటికి దగ్గరి సంబంధమున్న విషయాలను గానీ మళ్ళీ వాడకు): ${existingSummaries}

చాలా ముఖ్యం — ఖచ్చితత్వం: నీకు 100% ఖచ్చితంగా, నిస్సందేహంగా తెలిసిన, విస్తృతంగా validated అయిన fact మాత్రమే ఇవ్వు (శాస్త్రీయ పరిశోధన/విశ్వసనీయ సంస్థల ద్వారా ధృవీకరించబడినట్టు నీకు తెలిసినది). ఏమాత్రం అనిశ్చితి, సందేహం ఉన్నా, ఖచ్చితమైన సంఖ్యలు గుర్తు లేకపోయినా — fact ఇవ్వకుండా, జవాబుగా కేవలం ఒక్క మాట "UNSURE" అని రాయి, మరేమీ రాయకు.
...
1) ACCURACY: ఇందులో ఏదైనా సందేహాస్పదమైన, తప్పుగా ఉండే అవకాశం ఉన్న సంఖ్య, పేరు, లేదా వాదన ఉందా?

2) VIRAL APPEAL (0-100): కింద ఇచ్చిన అంశాలను దృష్టిలో పెట్టుకుని ఒక మొత్తం స్కోరు ఇవ్వు:
- Scroll-stopping power (మొదటి వాక్యం వినగానే scroll ఆపుతారా?)
- Curiosity (ఇంకా తెలుసుకోవాలని అనిపిస్తుందా?)
- Shock value ("నిజంగానా!" అనే reaction వస్తుందా?)
- Emotional reaction (surprise/wonder/disbelief కలిగిస్తుందా?)
- Shareability (friend కి పంపాలని అనిపిస్తుందా?)
- Comment potential (viewers చర్చించే/అడిగే అవకాశం?)
- తెలుగు audience relevance (సగటు తెలుగు viewer కి ఆసక్తి ఉంటుందా?)
- Visual potential (దీనికి బాగా సరిపోయే images/videos దొరికే అవకాశం ఉందా?)
- Retention potential (చివరి వరకూ suspense నిలబెట్టగలదా?)
- Originality (చాలామంది YouTube viewers కి తెలియనిదేనా?)

ఖచ్చితంగా ఈ 2-లైన్ల ఫార్మాట్‌లో మాత్రమే జవాబు ఇవ్వు:
ACCURACY: VERIFIED (పూర్తిగా ఖచ్చితమైనది అని నమ్మకం ఉంటేనే) లేదా REJECTED (ఏమాత్రం సందేహం ఉన్నా)
SCORE: (పైన ఇచ్చిన అంశాలన్నీ కలిపి ఆలోచించి, 0-100 మధ్య ఒక మొత్తం సంఖ్య మాత్రమే)`;
...
function buildPrompt(category, recentTitles, outline) {
  ...
  const topicInstruction = `నువ్వు ఒక expert YouTube Shorts scriptwriter వి, Telugu Amazing Facts వీడియోల కోసం. నీ లక్ష్యం కేవలం fact ని వివరించడం కాదు — audience retention, curiosity, rewatches మరియు subscriptions maximize చేసేలా, natural గా మాట్లాడే ఒక human storyteller లా అనిపించే script రాయడం, ఒక article చదివినట్టు కాదు.

కింద ఇచ్చిన fact (హుక్ ప్రశ్న + వివరణ + twist) ని తెలుగులో సహజంగా, ఆసక్తికరంగా చెప్పు. ఇది ఇప్పటికే verify చేయబడిన, పూర్తి fact — నువ్వు దీన్ని మార్చకూడదు, కొత్తగా ఏమీ కల్పించకూడదు, కేవలం విస్తరించి అందంగా చెప్పాలి:
...
3. **Twist:** పైన ఇచ్చిన twist నే **రెండు దశల్లో** చెప్పు — ముందు ఒక చిన్న suspense-build-up లైన్ ("కానీ... ఇక్కడే అసలు విషయం..." లాంటిది), తర్వాత అసలు twist ని punch లా reveal చేయి. కొత్త twist కల్పించకు — ఉన్నదాన్నే రెండు అడుగుల్లో చెప్పు.
...
**Delivery style గురించి — ఇది చాలా ముఖ్యం:** ఇది flat గా చదివినట్టు కాకుండా, natural, TTS-friendly పాజ్‌లతో ఆసక్తికరంగా ఉండాలి. **చిన్న చిన్న వాక్యఖండాలు (phrase fragments), "..." (మూడు చుక్కలు) తో dramatic pause ఇస్తూ** రాయి — ఇది ఒక వాక్యం మధ్యలో ఆగి, తర్వాతి భాగం చెప్పే స్టైల్. ఖచ్చితంగా ఈ ఉదాహరణ style లోనే రాయి:

"చాలామంది...
పెద్దయ్యాక ఎక్కువ ఎముకలు ఉంటాయని అనుకుంటారు.

కానీ...
అది పూర్తిగా తప్పు!

మీరు పుట్టినప్పుడు...
మీ శరీరంలో దాదాపు 300 ఎముకలు ఉంటాయి.

ఎందుకో తెలుసా?"

ఈ style లో గమనించాల్సినవి:
- "కానీ...", "అలా...", "ఎందుకో తెలుసా?" లాంటి చిన్న connector-phrases వాడు, ఆగి తర్వాతి భాగం చెప్పు.
- ప్రతి "..." తర్వాత న్యూలైన్ పెట్టు (ఇది మేము pause గా treat చేస్తాం).
- రెండు ఆలోచనల మధ్య ఖాళీ లైన్ పెట్టు (paragraph break లా).
- ఇది "అసంపూర్ణ వాక్యం" తప్పు కాదు — ఇది ఉద్దేశపూర్వక dramatic pause, TTS కి సహజంగా ఆగి మళ్ళీ చెప్పినట్టు అనిపించడానికి.
- రిటోరికల్ ప్రశ్నలు వాడు ("ఎందుకో తెలుసా?", "అద్భుతంగా ఉంది కదా?") — వినేవారిని engage చేయడానికి.
- **ప్రతి వాక్యఖండం (fragment) సాధారణంగా 5-12 తెలుగు పదాల మధ్య ఉండాలి, పొడవులు కలిపి మారుతూ ఉండాలి** — అన్ని fragments ఒకే పొడవులో ఉంటే robotic గా అనిపిస్తుంది. మనిషి సహజంగా మాట్లాడేటప్పుడు కొన్ని చిన్నవి ("కానీ..."), కొన్ని కొంచెం పొడవైనవి ఉంటాయి — ఆ variation వాడు.
- ఇది ఒక Wikipedia article చదివినట్టు అనిపించకూడదు — ఒక professional YouTube Shorts narrator, ఒక friend కి ఆసక్తికరమైన విషయం చెప్తున్నట్టు అనిపించాలి.
- ఇది **news reader చదివినట్టు కాకుండా, ఒక voice actor dialogue లా** అనిపించాలి. తేడా చూడు — flat: "ఇది ప్రపంచంలో అత్యంత ఖరీదైన ఆహారం." vs voice-actor style: "కానీ... ఇక్కడే అసలు షాక్ ఉంది... ఇదే... ప్రపంచంలో అత్యంత ఖరీదైన ఆహారం!" — ప్రతి fact/twist ని ఈ రెండో style లోనే రాయి.
- ప్రతి ముఖ్యమైన fact/సంఖ్య చెప్పే ముందు, ఒక suspense-building చిన్న line వేయి (ఉదా. "నమ్మలేరు..." "ఇక్కడే అసలు విషయం...").
...
- పైన చూపిన ఉదాహరణలా, "..." వాడుతూ, న్యూలైన్‌లతో, natural pause style లో రాయి.
- **పూర్ణవిరామం (.) ఎప్పుడూ ఒక పూర్తి ఆలోచన ముగిసిన చోటే పెట్టు — వాక్యం మధ్యలో, ముఖ్యంగా క్రియ (verb) కి ముందు ఎప్పుడూ పెట్టకు.** తప్పు ఉదాహరణ (ఇలా చేయకు): "అది వాటిని నీటిలో తేలిపోవడం నుంచి. రక్షిస్తుంది..." — ఇది తప్పు, ఎందుకంటే "రక్షిస్తుంది" అనే క్రియ ముందు వాక్యానికే చెందుతుంది, విడిగా కాదు. సరైనది: "అది వాటిని నీటిలో తేలిపోవడం నుంచి రక్షిస్తుంది..." (ఒకే వాక్యంగా, మధ్యలో "..." pause వాడొచ్చు గానీ period వద్దు). "..." ఎప్పుడూ dramatic pause కోసమే, period ఎప్పుడూ genuine వాక్యాంతం కోసమే — ఈ రెండూ కలిపి వాడకు.
- సంఖ్యలు **1000 మరియు అంతకంటే ఎక్కువ** ఉంటే, ఎప్పుడూ తెలుగు మాటల్లోనే రాయి (10000 → "పది వేలు", 2000 → "రెండు వేలు") — అంకెల్లో ఎప్పుడూ వద్దు. **తప్పు ఉదాహరణ (ఇలా చేయకు): "10,000 సంవత్సరాలు"** — దీన్ని TTS "సున్నా సున్నా సున్నా సున్నా" అని digit-by-digit చదివేస్తుంది, "పది వేలు" అని కాదు. **1000 కన్నా తక్కువ సంఖ్యలు మాత్రమే** (300, 206 వంటివి) అంకెల్లో వాడొచ్చు, ఇవి TTS కి సహజంగా వినిపిస్తాయి.
...
నీ అత్యంత ముఖ్యమైన లక్ష్యం audience retention. ప్రతి 5-8 సెకన్లకూ ఒక కొత్త curiosity/surprise పరిచయం చేయి. వినేవారికి ఎప్పుడూ "అసలైన reveal ఇంకా రావాల్సి ఉంది" అనే feeling ఉండాలి. energy ఎప్పుడూ తగ్గకూడదు — 80%+ audience retention సాధించేలా రాసినట్టు రాయి.

ఈ fact ని ఒక **రహస్యం బయటపెడుతున్నట్టు** చెప్పు, ఒక science lesson చెప్తున్నట్టు కాదు. కష్టమైన శాస్త్రీయ పదాలు (జీవశాస్త్ర కుటుంబాల పేర్లు వంటివి) ఉంటే, ముందు దాన్ని సులభమైన తెలుగులో వివరించు, ఆ శాస్త్రీయ పేరు అవసరమైతే మాత్రమే, **ఒక్కసారే** ప్రస్తావించు — పదేపదే వాడకు. Twist ని script మధ్యలో (దాదాపు 60-65% సమయానికి) తీసుకురా, చివర్లో కాకుండా — చివరి వరకూ ఆగితే viewer అంతకుముందే scroll చేసేసే అవకాశం ఉంది.${avoidLine}`;
...
async function generateContent(category, recentTitles, outline, ctaSentence) {
  ...
  for (let retryAttempt = 1; retryAttempt <= 2 && (wordCount < target.min - 15 || bestWordCount > MAX_SAFE_WORDS); retryAttempt++) {
    ...
    const retryPrompt = tooLong
      ? `కింద ఇచ్చిన fact ని తెలుగులో చెప్పు — ఖచ్చితంగా ${target.min}-${target.max} తెలుగు పదాలు ఉండాలి (మీ మునుపటి ప్రయత్నం ${bestWordCount} పదాలు వచ్చింది, ఇది చాలా ఎక్కువ — వీడియో 80 సెకన్ల లోపు ఉండాలి). ఇచ్చిన fact లోని ముఖ్యమైన భాగాలనే ఉంచి, అనవసరమైన వివరణ తగ్గించి, సంక్షిప్తంగా చెప్పు:\n\n${outline}\n\nనియమాలు: ఇచ్చిన fact నే చెప్పు, కొత్త కల్పితం జోడించకు. ఖచ్చితంగా తెలుగు లిపిలోనే రాయి. "..." తో dramatic pause ఇస్తూ, 8 పదాల లోపు చిన్న వాక్యఖండాలతో రాయి. CTA/emoji వద్దు.\n\nజవాబు ఫార్మాట్:\nTITLE: (5-8 పదాల శీర్షిక, emoji వద్దు)\nKEYWORDS: (3 నిర్దిష్ట ఆంగ్ల keywords)\nHOOK: (hook ప్రశ్న, 15 పదాల లోపు, emoji వద్దు)\nSCRIPT: (సంక్షిప్త వాయిస్-ఓవర్ టెక్స్ట్, emoji/CTA వద్దు)`
      : `కింద ఇచ్చిన fact ని తెలుగులో వివరణాత్మకంగా చెప్పు — ఖచ్చితంగా ${target.min}-${target.max} తెలుగు పదాలు ఉండాలి (మీ మునుపటి ప్రయత్నం కేవలం ${wordCount} పదాలు మాత్రమే వచ్చింది, ఇది చాలా తక్కువ, padding చేయకుండా fact ని పూర్తిగా వివరించి ఈ నిడివికి చేరుకో):

${outline}

నియమాలు: ఇచ్చిన fact నే విస్తరించి చెప్పు, కొత్త కల్పితం/సంఖ్యలు జోడించకు. ఖచ్చితంగా తెలుగు లిపిలోనే రాయి (Romanized వద్దు). "..." తో dramatic pause ఇస్తూ, 8 పదాల లోపు చిన్న వాక్యఖండాలతో, న్యూలైన్‌లతో రాయి (ఉదా: "కానీ...\nఅది నిజం కాదు!") — flat, పొడవైన వాక్యాలు వద్దు. **Period (.) ఎప్పుడూ క్రియకి ముందు/వాక్యం మధ్యలో పెట్టకు — పూర్తి ఆలోచన ముగిసిన చోటే.** CTA/emoji వద్దు.
