  ...
  for (let attempt = 1; attempt <= maxAttempts; attempt++) {
    ...
    try {
      ...
      if (candidate) {
        ...
        if (isVerified) {
          log(`  Fresh fact VERIFIED on attempt ${attempt} — using it for this video.`);
...
const CTA_VARIATIONS = [
  ...
  'మీకు నచ్చితే... Like, Share చేసి, ఒక్క సబ్‌స్క్రైబ్ చాలు!',
...
- **ప్రతి వాక్యఖండం (fragment) 8 తెలుగు పదాల లోపే ఉండాలి** — పొడవైన వాక్యాలు TTS ని news-reader లా వినిపిస్తాయి.
