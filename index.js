...
function buildPrompt(category, article, recentTitles, runCount) {
  ...
  if (category === 'news') {
    ...
    topicInstruction = `కింద ఇచ్చిన కథను తీసుకుని, దాన్ని తెలుగులో వివరణాత్మకంగా, ఆసక్తికరంగా చెప్పు. ఇది ఇప్పటికే పూర్తి, సరైన కథ — నువ్వు కథను మార్చకూడదు, కొత్తగా ఏమీ కల్పించకూడదు, కేవలం విస్తరించి, అందంగా చెప్పాలి:

కథ: ${outline}

ఇలా చేయి:
1. పైన ఇచ్చిన కథలోని పాత్రలు, సంఘటనలు, క్రమం ఖచ్చితంగా అలాగే ఉంచు (పేర్లు తెలుగులో అనుకూలంగా పెట్టుకోవచ్చు) — కథను మార్చకు, తర్కాన్ని విరగొట్టకు.
2. కేవలం "ఏమి జరిగింది" అని listing చేయడం కాకూడదు — నిజంగా ఒక కథ చెప్తున్నట్టు రాయి: కనీసం ఒక చోట పాత్రల మధ్య మాటలు (dialogue) వాడు, సన్నివేశాన్ని కళ్ళకు కట్టేలా చిన్న వివరణ ఇవ్వు.
3. **Suspense/curiosity పట్టుకుని ఉంచాలి:** "ఒకప్పుడు ఒక ఊళ్ళో..." లాంటి సాధారణ ఆరంభం వద్దు — ఒక ఉద్విగ్నమైన క్షణం/ప్రశ్నతో మొదలుపెట్టు. కథ మధ్యలో ఫలితం ముందే చెప్పకు, చివరి వరకూ ఉత్కంఠ కొనసాగించు.
4. కథ చివర్లో, ఒక ప్రత్యేక వాక్యంగా, ఖచ్చితంగా ఇలా మొదలుపెట్టి నీతిని స్పష్టంగా చెప్పాలి: "ఈ కథ నుండి మనం నేర్చుకునేది ఏమిటంటే..." — ఈ నీతి వాక్యం **${moralValue}** గురించే ఉండాలి.${avoidLine}`;
