...
ఈ fact ని ఒక **రహస్యం బయటపెడుతున్నట్టు** చెప్పు, ఒక science lesson చెప్తున్నట్టు కాదు. కష్టమైన శాస్త్రీయ పదాలు ఉంటే ముందు సులభమైన తెలుగులో వివరించు, శాస్త్రీయ పేరు అవసరమైతే ఒక్కసారే వాడు. Twist ని script మధ్యలో (60-65% సమయానికి) తీసుకురా, చివర్లో కాకుండా.

**కఠినమైన నియమం:** ప్రతి వాక్యం ఈ నాలుగింటిలో కనీసం ఒకటి కలిగి ఉండాలి — Surprise, Curiosity, Twist, లేదా Emotional reaction. ఏదీ లేని plain-information వాక్యం (ఉదా. "సంక్లిష్ట నెట్‌వర్క్ రూపం ఇక్కడ ఏర్పడుతుంది" లాంటి textbook-style వాక్యం) రాయకు — అలాంటిది రాయాల్సి వస్తే, దాన్ని తీసేసి direct గా curiosity/twist వైపుకి వెళ్ళు. **Audience వినేది వినోదం కోసం ముందు, నేర్చుకోవడం కోసం తర్వాత** — ఇది ఎప్పుడూ గుర్తుంచుకో.${avoidLine}

---
ఇక్కడ 3 అతి ముఖ్యమైన నియమాలు, మళ్ళీ గుర్తుచేస్తున్నాను:
1. FORMAT: జవాబు తప్పకుండా "TITLE:" అనే పదంతోనే మొదలవ్వాలి, మరేమీ దానికి ముందు రాయకు (ఇంట్రో, వివరణ ఏమీ వద్దు).
2. STYLE: ప్రతి వాక్యం "..." pause లతో, curiosity/surprise/twist తో ఉండాలి — plain fact-statement వాక్యాలు వద్దు.
