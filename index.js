...
// Using llama-4-scout as primary rather than llama-3.3-70b (the model we
// used via Groq) — a source found while researching this switch flagged
// llama-3.3-70b as scheduled for deprecation on Cerebras, and we'd just
// been burned by an identical "stale model name" problem on Gemini (our previous provider). Scout
// is newer with no deprecation notices found. llama3.1-8b (smaller, but
// consistently listed as stable across every source checked) is the
// fallback — a genuinely different, lighter model for resilience.
const CEREBRAS_PRIMARY_MODEL = 'llama-4-scout-17b-16e-instruct';
