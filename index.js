...
నువ్వు ఒక professional YouTube Shorts storyteller వి. ఈ 4 techniques తప్పనిసరిగా వాడి, ఈ beats ని తెలుగు narration గా విస్తరించు:

1. **Personal scenario తో మొదలుపెట్టు** — abstract topic-statement కాదు, viewer ప్రతిరోజూ చేసేదానితో connect చేయి.
2. **Assumption → Correction** — ముందు ఒక సహజమైన ఊహ అడిగి, తర్వాత "కాదు..." అని తిప్పికొట్టు.
3. **ప్రతి సంఖ్యకీ తప్పనిసరిగా ఒక comparison ఇవ్వు** — raw number మాత్రమే చెప్పకు, దాన్ని ఊహించగలిగే దానితో పోల్చు.
4. **Consequence తో ముగించు** — ఇది ఎందుకు ముఖ్యమో, నిజ జీవితంలో ఏం జరుగుతుందో చూపించు.

ఉదాహరణ (ఈ 4 techniques ఎలా కలిసి పనిచేస్తాయో చూడు):
"🤯 మీరు అమెరికాకు WhatsApp మెసేజ్ పంపితే...
అది నిజంగా...
శాటిలైట్ ద్వారా వెళ్తుందని అనుకుంటున్నారా?
కాదు...
ప్రపంచంలోని దాదాపు 95% ఇంటర్నెట్...
సముద్రం అడుగున ఉన్న కేబుల్స్ ద్వారానే ప్రయాణిస్తుంది!
ఇంకా షాక్ ఏంటంటే...
ఆ కేబుల్స్ మొత్తం పొడవు...
12 లక్షల కిలోమీటర్లకు పైగా ఉంటుంది!
అంటే...
భూమిని దాదాపు 30 సార్లు చుట్టేయగలంత!
అందుకే...
ఒక సముద్రపు కేబుల్ దెబ్బతింటే...
కొన్ని దేశాల్లో ఇంటర్నెట్ కూడా ప్రభావితమవుతుంది!"

గమనించు: ప్రతి వాక్యం ఒక్క idea మాత్రమే, "..." తో pause, numbers ఎప్పుడూ ఒంటరిగా రావు (ఎప్పుడూ ఒక comparison తో వస్తాయి). ఇదే స్థాయి specificity తో, ఇచ్చిన beats content కి రాయి — పైన ఉన్న ఉదాహరణ content ని కాపీ చేయకు, ఇది కేవలం STYLE reference.
...
{"hook": "...", "question": "...", "reveal": "...", "twist": "...", "ending": "..."}`;
  ...
  // a much bigger quality hit than the cost of one extra Groq call.
  if (!beats) {
...
async function generateContent(category, recentTitles, outline, ctaSentence) {
  ...
  let script = (await callGroq(narrationPrompt)).trim();
...
నియమాలు: JSON లోని beats క్రమాన్నే విస్తరించి చెప్పు, కొత్త కల్పితం/సంఖ్యలు జోడించకు. Personal scenario తో connect చేయి, assumption→correction technique వాడు ("...అనుకుంటున్నారా? కాదు..."), ప్రతి సంఖ్యకీ ఒక comparison ఇవ్వు, consequence తో ముగించు. ఖచ్చితంగా తెలుగు లిపిలోనే రాయి (Romanized వద్దు). "..." తో dramatic pause ఇస్తూ, 8 పదాల లోపు చిన్న వాక్యఖండాలతో, న్యూలైన్‌లతో రాయి (ఉదా: "కానీ...\nఅది నిజం కాదు!") — flat, పొడవైన వాక్యాలు వద్దు. **Period (.) ఎప్పుడూ క్రియకి ముందు/వాక్యం మధ్యలో పెట్టకు — పూర్తి ఆలోచన ముగిసిన చోటే.** CTA/emoji/టైటిల్/లేబుల్స్ వద్దు — కేవలం narration టెక్స్ట్ మాత్రమే ఇవ్వు.`;
    const retryScript = (await callGroq(retryPrompt)).trim();
  ...
  const metaRaw = await callGroq(metadataPrompt);
