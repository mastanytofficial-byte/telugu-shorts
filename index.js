...
1. నిజంగా లేని/విరిగిపోయిన/అర్థం లేని పదం (garbled లేదా invented word) — ఉదా. గతంలో ఒక script లో "సముద్రపు వర్షాభి" అని వచ్చింది, కానీ "వర్షాభి" తెలుగులో నిజమైన పదమే కాదు (బహుశా "వర్షారణ్యాలు" అనే పదం అసంపూర్తిగా వచ్చింది) — సరైనది: "సముద్రపు వర్షారణ్యాలు" (rainforests of the sea). **ఇదే category లో ప్రత్యేకంగా జాగ్రత్తగా చూడాల్సింది — ఆంగ్ల పదాలను/పేర్లను తెలుగు లిపిలోకి transliterate చేసినప్పుడు అక్షరాలు/మాత్రలు తప్పుగా కలిసిపోవడం:** ఉదా. గతంలో "కాంగ్రెస్మెం" (సరైనది "కాంగ్రెస్‌మెన్" — Congressmen, చివర్లో "న్" మాయమైంది), "బైోమెట్రిక్" (సరైనది "బయోమెట్రిక్" — biometric, "బై" తప్పు మాత్ర కలయిక), "పన్నెడు" (సరైనది "పన్నెండు" — 12, మధ్యలో "ండ" మాయమైంది) వంటివి వచ్చాయి — ఇవి చూడటానికి నిజమైన పదంలానే అనిపించొచ్చు, కానీ నిజానికి తెలుగులో లేని పదాలు. ప్రతి English transliteration/సంఖ్య పదాన్ని కూడా ఒక సాధారణ తెలుగు పదంతో సమానంగా జాగ్రత్తగా పరిశీలించు.
...
3. ఆ వాక్యంలో ఒంటరిగా చూస్తే సరైనట్టు అనిపించే నిజమైన పదమే, కానీ స్క్రిప్ట్‌లో మిగతా చోట్ల ఏర్పడే అసలు theme/scene/setting కి విరుద్ధంగా ఉంది. ఉదాహరణలు: (a) గతంలో ఒక script హుక్ లో "ఒకే చిత్రాన్ని చూసి మన మెదడు సజీవం లేదా చల్లటి అనిపించగలదా?" అని వచ్చింది — "సజీవం" (alive) నిజమైన పదమే, ఆ వాక్యం ఒంటరిగా చదివితే తప్పు అనిపించదు, కానీ ఆ స్క్రిప్ట్ మొత్తం "వెచ్చని vs చల్లని రంగు perception" గురించి — కాబట్టి "సజీవం" కి బదులు "వెచ్చగా"/"వేడిగా" రావాలి. (b) గతంలో ఒక script లో నీటిలో ఉండే ఎలెక్ట్రిక్ ఈల్ ఒక జీవిని వేటాడే సన్నివేశంలో "మునుగుతున్న రోడ్డులో చంపుటకు ఉపయోగించి" అని వచ్చింది — "రోడ్డు" (road) నిజమైన, సరిగ్గా spell అయిన పదమే, కానీ నీటి అడుగున ఉండే scene కి "రోడ్డు" అనేది పూర్తిగా అసందర్భం, అక్కడ ఉండకూడని వస్తువు/స్థలం — ఇలాంటి scene/setting కి సరిపోని పదాలను కూడా ఇదే category లో పట్టుకుని, ఆ scene కి సరిపోయే పదంతో (లేదా ఆ పదబంధాన్ని తీసేయడం ద్వారా) సరిచేయాలి. ఇలాంటి తప్పుల్ని పట్టుకోవాలంటే స్క్రిప్ట్ మొత్తం చదివిన తర్వాతే ఏ ఒక్క వాక్యాన్ని judge చేయాలి, వాక్యాన్ని ఒంటరిగా చూసి కాదు.
...
5. మొదటి వాక్యం (హుక్) ఒక నిర్దిష్ట ప్రశ్న/claim అడిగింది, కానీ script లో తర్వాత వచ్చే వాక్యాలు ఆ నిర్దిష్ట ప్రశ్న/claim కి జవాబు ఇవ్వవు లేదా వివరించవు — ఉదా. గతంలో ఒక script హుక్ లో "ఎలెక్ట్రిక్ ఈల్స్ తమ స్వంత విద్యుత్తుతో అంధులైపోతాయా?" (do they go blind from their own electricity?) అని అడిగింది, కానీ తర్వాతి వాక్యాలు అన్నీ ఎంత voltage తయారుచేస్తాయో, ఎంత దూరంలో target ని shock చేస్తాయో మాత్రమే చెప్తాయి — "అంధులైపోవడం" (blindness) గురించి ఎక్కడా ప్రస్తావనే లేదు. ఇలాంటప్పుడు హుక్ ప్రశ్నని, script లో తర్వాత నిజంగా వివరించే విషయానికి సరిపోయేలా (ఇక్కడ: voltage/shock power గురించి), **దాదాపు అదే పొడవుతో** తిరిగి రాయి — script లో మిగతా భాగం మార్చకు.
