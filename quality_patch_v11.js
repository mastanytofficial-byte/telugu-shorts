...
'    "- Aim for 6-10 short spoken lines and about 55-95 Telugu words. Do not pad a short fact with unrelated information.",',
...
'  if (wc < 55 || lines.length < 6) throw new Error("Final script too short: " + wc + " words / " + lines.length + " lines.");',
